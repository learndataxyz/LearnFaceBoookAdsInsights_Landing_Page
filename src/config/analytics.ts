...
export const googleAnalyticsMeasurementID = 'G-6HDFTXVLKW'//import.meta.env.PUBLIC_GA_TRACKING_ID // Replace with your Google Analytics Measurement ID (e.g. "G-XXXXXXXXXX")
